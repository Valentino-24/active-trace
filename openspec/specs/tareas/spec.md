...
> Sistema de tareas internas y trazabilidad de trabajo docente. Permite crear, asignar, comentar y gestionar el ciclo de vida de tareas entre PROFESORES, TUTORES y COORDINADORES dentro del tenant.

## Permisos

| Permiso | Descripción | Asignado a |
|---------|-------------|-----------|
| `tareas:gestionar` | Crear, reasignar, cambiar estado, comentar tareas | PROFESOR, TUTOR, COORDINADOR, ADMIN |
